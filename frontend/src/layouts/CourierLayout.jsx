...
import { LayoutDashboard, Briefcase, Truck, MessageSquare, UserCircle, LogOut, Warehouse, ChevronLeft, ChevronRight, Home } from 'lucide-react'
        ...
        <Link to="/" className={`flex items-center gap-3 px-4 py-4 border-b border-white/8 hover:bg-white/5 transition-colors ${collapsed ? 'justify-center' : ''}`}>
          ...
          {!collapsed && (
            <div>
              ...
              <p className="text-white/40 text-[10px] mt-0.5">Courier Portal</p>
            </div>
          )}
        </Link>
