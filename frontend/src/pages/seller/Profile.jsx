...
import { User, Mail, Phone, Save, Lock, Eye, EyeOff, ShoppingBag } from 'lucide-react'
  ...
  return (
    <div className="max-w-2xl space-y-5">
      <div className="flex items-center gap-4 animate-fade-in-up">
        ...
        <div>
          <h2 className="font-display font-black text-xl text-[#1c1917]">{form.full_name || 'Seller'}</h2>
      ...
      {tab === 'security' && (
        <form onSubmit={handlePasswordChange} className="bg-white border border-border rounded-xl p-6 animate-fade-in-up space-y-5">
          <div>
            ...
            <p className="text-xs text-[#71717a]">Make sure your account stays secure</p>
          </div>
          <div className="space-y-4">
            {[
      ...
      <div className="bg-chalk-dark border border-border rounded-xl p-5 animate-fade-in-up">
        <h3 className="font-display font-bold text-[#1c1917] text-sm mb-1">Account Details</h3>
