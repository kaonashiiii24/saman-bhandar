...
import { User, Mail, Phone, Save, Lock, Eye, EyeOff, Home } from 'lucide-react'
    ...
    <div className="max-w-2xl space-y-5">
      <div className="flex items-center gap-4 animate-fade-in-up">
        <div className="w-16 h-16 rounded-2xl bg-[#1c1917] flex items-center justify-center text-white font-display font-black text-2xl shrink-0">
          {form.full_name?.charAt(0)?.toUpperCase() || 'H'}
        </div>
        <div>
          <h2 className="font-display font-black text-xl text-[#1c1917]">{form.full_name || 'Host'}</h2>
      ...
      {tab === 'security' && (
        <form onSubmit={handlePasswordChange} className="bg-white border border-border rounded-xl p-6 animate-fade-in-up space-y-5">
          <div>
            ...
            <p className="text-xs text-[#71717a]">Keep your host account secure</p>
          </div>
          <div className="space-y-4">
            {[
